...
func (x *FindOneData) GetStock() string {
	if x != nil {
		return x.Stock
	}
	return ""
...
func (x *FindOneData) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *FindOneRequest) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x6b, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
